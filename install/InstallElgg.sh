...
# Ubuntu 15.10 / Elgg 2.1.1 / Kpax 2
#
#################################################
...
apt-get install php5 libapache2-mod-php5 php5-mysqlnd php5-gd
read -rsp $'Press any key to continue...\n' -n1
...
cd /var/www/
wget http://elgg.org/getelgg.php?forward=elgg-2.1.1.zip -O elgg.zip > /dev/null
...
ln -sf /var/www/html/elgg-2.1.1 /var/www/html/kpax2
